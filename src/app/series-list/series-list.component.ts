...
import {SeriesListService} from './shared/series-list.service';
...
export class SeriesListComponent implements OnInit {
  ...
  ngOnInit() {
    this.route.paramMap.subscribe((params: ParamMap) => {
      ...
      this.study_ID = params.get('studyID');
  ...
  async getStudyID(study_ID) {
    let study = await this.seriesListService.getStudyByID(study_ID) as StudyModel;
